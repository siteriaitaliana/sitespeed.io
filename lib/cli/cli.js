...
module.exports.parseCommandLine = function parseCommandLine() {
   ...
   */
    ...
    .option('grafana.host', {
      describe:
        'The Grafana host used when sending annotations. If you set a host, annotations will be stored in Grafana instead of Graphite/InfluxDB.',
      group: 'Grafana'
    })
    .option('grafana.port', {
    ...
    .option('grafana.apitoken', {
      describe:
        'The Grafana API token. Create one before you use Grafana annotations: http://docs.grafana.org/http_api/auth/#create-api-token',
      group: 'Grafana'
    })
    /**
     Graphite cli option
